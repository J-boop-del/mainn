...
video = "https://t.me/IMI10l/5"
local list = Redis:smembers(Fast.."total")
local JABWA = "*✭ عدد مشتركين بوتك『 "..#list.." 』مشترك*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✭ سورس الجوكر ✭', url = 't.me/b5hp_t '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/YYYTTTY_1 '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("YYYTTTY_1")
...
local TestText = "*✯ مبرمج سورس جوكر ✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/YYYTTTY_1"}
},
}
...
video = "https://t.me/IMI10l/5"
local T = "*✭ مـرحـبا انـا صـانـع بـوتـات\n✭ اقوم بصنع بوتات حمايه\n✭ تم برمجتي من قبل المطور جوكر\n✭ للتنصيب الحمايه ارسل /Yso\n✭ او اتبع الازرار بالاسفل*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✭ المبرمج جوكر ✭', url = 't.me/YYYTTTY_1 '},
},
{  
{text = '✭ سورس الجوكر ✭', url = 't.me/b5hp_t '},
},
...
photo = "https://t.me/b5hp_t"
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𝐘𝐒𝐎](t.me/b5hp_t )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/YYYTTTY_1 '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/YYYTTTY_1'},
},
{
{text = '• قناة التحديثات •', url = 't.me/b5hp_t '},
},
{  
{text = '• 𝐒𝐎𝐔𝐑𝐂𝐄 𝐘𝐒𝐎 •', url = 't.me/b5hp_t '},
},
}
local msgg = msg.id/2097152/0.5
